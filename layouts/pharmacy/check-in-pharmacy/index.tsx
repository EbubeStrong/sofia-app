...
import CheckinSuccessLayout from "@/layouts/checkin/CheckinSuccess";
import PatientList from "@/layouts/checkin/PatientList";
import PharmacyNewPatientForm from "@/components/Pharmacy/Forms/PharmacyNewPatientForm";
import PharmacyCheckinSuccessLayout from "./PharmacyCheckinSuccess";

interface CheckinLayoutProps {
  initialData: TCheckinsResp["data"];
}

const PharmacyCheckinLayoutModule: React.FC<CheckinLayoutProps> = ({ initialData }) => {
  ...
  return (
    <div className="flex flex-col gap-7">
      ...
      <SofiaModal
        ...
        maskClosable={false}
        content={
          <PharmacyCheckinSuccessLayout setOpenCheckinSuccess={setOpenCheckinSuccess} />
        }
        closeIcon={false}
      />
...
export default PharmacyCheckinLayoutModule;

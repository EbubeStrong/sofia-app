...
import { useChangeReceptionPassword } from "@/services/checkins";
...
const ReceptionPasswordForm: React.FC<TChangePasswordProps> = ({
  openPassword,
  setOpenPassword,
}) => {
...
export default ReceptionPasswordForm;

...
import { DoctorsNoteTableColumns } from "@/data/doctors-note-data";

interface IDoctorsNoteTableSectionProps {
  patientId: string;
}

const DoctorsNoteTableSection: React.FC<IDoctorsNoteTableSectionProps> = ({
  patientId,
}) => {
  const cssProps = {
    $height: "38px",
  ...
  return (
    <section className="flex flex-col gap-5 mt-5">
      ...
      <Suspense>
        <SofiaTable
          columns={DoctorsNoteTableColumns() as ColumnType[]}
...
export default DoctorsNoteTableSection;

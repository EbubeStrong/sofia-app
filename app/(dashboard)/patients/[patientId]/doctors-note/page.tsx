...
import DoctorHistoryLayout from "@/layouts/doctors-note/DoctorHistory";
...
const DoctorsNoteHistoryModule: React.FC<{
  ...
  return (
    ...
    >
      <DoctorHistoryLayout patientId={patientId} />
    </PatientRecordWrapper>
  );
};

export default DoctorsNoteHistoryModule;

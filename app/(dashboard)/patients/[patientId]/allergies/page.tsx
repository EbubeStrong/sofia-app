...
import AllergyHistoryLayout from "@/layouts/allergies/AllergyHistory";
...
const AllergiesHistoryModule: React.FC<{
  ...
  return (
    ...
    >
      <AllergyHistoryLayout patientId={patientId} />
    </PatientRecordWrapper>
  );
};

export default AllergiesHistoryModule;
